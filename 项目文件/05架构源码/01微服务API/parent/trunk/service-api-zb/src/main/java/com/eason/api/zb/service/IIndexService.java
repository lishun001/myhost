...
public interface IIndexService {
	 ...
	 * @apiSuccess {Integer} onlineUser  真实在线用户
	 * @apiSuccess {Integer} machineUser 机器用户
	 * @apiSuccess {String} roomBackgroundImg  房间背景图片
	 * @apiSuccess {Integer} zbStatus  	直播状态： 1=直播中，2=未开播，3=回放中
	 * @apiSuccess {Timestamp} startTime  	房间开播时间
	 * @apiSuccess {String} [gameIcon]  	游戏图标
	 */
	 ...
	 * @apiSuccess {String} eventUrl 	跳转地址
