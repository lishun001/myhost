...
@Sharable
public class OCPServerInHandler_Multi_v1 extends ChannelInboundHandlerAdapter {

    private static Logger logger = LoggerFactory.getLogger(OCPServerInHandler_Multi_v1.class);
    private static Logger exception_logger = LoggerFactory.getLogger("exception_logger");
    private BlockingQueue<MessageEntity> requestDataQueue;
    @Autowired
    ...
    public OCPServerInHandler_Multi_v1() {
        init();
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg)
        ...
        requestDataQueue.put(new MessageEntity(channel, result1));
    ...
    public final void init() {
        requestDataQueue = new LinkedBlockingQueue<MessageEntity>(MessageConfConst.MSG_QUEUE_LENGTH);
        ...
        for (int i = 0; i < CONSUMERS; i++) {
            final Future<?> future = service.scheduleAtFixedRate(new Consumer(), 0, 10, TimeUnit.MILLISECONDS);
    ...
    class Consumer implements Runnable {
        ...
        public void run() {
            try {
                ...
                MessageEntity entity = requestDataQueue.take();
...
//                        deductQointRequestDTO.setGameServerId(ServerIpCache.tempServerList.get(channel));
                ...
                if (responseDTO != null) {
                    ...
                    logger.info("{\"Type\":\"Response\", \"Game_Server\":\"" + gameServerIp + "\", \"Msg_Code\":\"0x" + Integer.toHexString(responseDTO.getHeader().getMessageCode()) + "\","
