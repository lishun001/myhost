...
public class PlatformManager {
    ...
    public String getMediaAccessToken() throws Exception {
    ...
    public Map<String, Object> getRtmpUrl(Integer zbId, String media_access_token,String token) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    public Boolean deleteRecFile(Integer zbId, String rtmpurl) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        Map<String, String> reqMap = new HashMap<>();
        reqMap.put("UserId", zbId + "");
    ...
    public String getImAccessToken() throws Exception {
    ...
    public Map<String, Object> getImUrl(Integer zbId, String im_access_token,String token) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        Map<String, String> reqMap = new HashMap<>();
