...
public interface IPlatformService {
	 ...
	 * @api {GET} /platform/media/get 获取media地址
	 * @apiName getMedia
	 *
	 *
	 * @apiDescription
	 ...
	 * @apiGroup platform
	 * @apiPermission Android/IOS
	 * @api {GET} /platform/im/get 获取im地址
	 * @apiName getIM
	 *
	 *
	 * @apiDescription
	 ...
	 *
	 * @apiSuccess {Integer} type  即时通讯类型
	 * @apiSuccess {String}  url   即时通讯地址
	 * @apiSuccess {String}  port  即时通讯端口
	 * @apiSuccess {String}  access_token   访问token
	 */
