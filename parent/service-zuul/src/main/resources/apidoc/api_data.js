define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/gift/sendBombScreen/{zbId}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/gift/sendGift/{zbId}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/platform/im/get/{zbId}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/platform/media/get/{zbId}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/room/{roomId}/enterRoom"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/room/getRoomWaterMarkImg"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/room/{roomId}/isCharged"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/task/resetTrySee"
      }
    ]
  },
  {
    ...
    "title": "用户详情",
    "name": "getDetail",
    "description": "<blockquote> <p>用户详情</br></p> </blockquote>",
    "success": {
      "fields": {
        "Success 200": [
          {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/user/getDetail"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/user/{channel}/isAttention/{userIds}/{isAttention}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/user/{channel}/isBlack/{userIds}/{isBlack}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/user/isBook/{zbId}/{isBook}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/user/isTrySee/{roomId}/{isTrySee}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/apply"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/getReadyPlayInfo"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/getStat/{planId}"
      }
    ]
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "isBook",
            "description": "<p>用户是否预约（0=未预约，1=已预约）</p>"
          },
          {
            "group": "Success 200",
            "type": "Integer",
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/getZbDetail/{zbId}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/getZhuboList/{num}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/overPlay/{planId}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/saveVideo/{planId}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.0.109:8769/api/zhubo/startPlay"
      }
    ]
  }
] });
